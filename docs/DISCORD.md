...
- **Описание сервера** (оно видно в окне приглашения):
  ...
  > Club — a first-person utility client for Minecraft (Fabric 1.21.1 / 1.21.6 / 1.21.8 / 1.21.11). Open source, MIT. Not a cheat client.
...
```
# Club
A first-person utility client for Minecraft 1.21.1 / 1.21.6 / 1.21.8 / 1.21.11 · Fabric · MIT
