 ...
 * a ~50%-alpha {@code bg1} fill + a soft light hairline. Text sits on a soft dark shadow ({@link #textShadow})
 * for depth + legibility over the world. Flat — no glow. Render-only.
 */
