...
// twin is club:core/club_ui_shape330.fsh. The #version line is the ONLY difference between the two files: it must be a
...
// com.club.compat.ShapePipe picks between the two; the fragment maths lives in the include.
#moj_import <minecraft:dynamictransforms.glsl>
#moj_import <club:club_shape_frag.glsl>
